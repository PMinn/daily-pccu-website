    ...
    <div>
      ...
      <section id="cover" className="section">
        ...
        <div className="right-block">
          ...
          <svg className="blob" viewBox="0 0 900 900" width="900" height="900" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" xmlnsSvgjs="http://svgjs.dev/svgjs" xmlnsData="ApexChartsNS">
      ...
      <section id="functions" className="section">
        <div className="table">
      ...
      <section id="add_friend" className="section">
        <h2>如何加入</h2>
        <div className="table">
          <div>
            <h3>點擊按鈕</h3>
            <div data-href="https://lin.ee/h0kZmTc" id="line_btn">
